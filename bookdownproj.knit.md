...
```
## Warning in rm(promedio): object 'promedio' not found
```
...
<img src="bookdownproj_files/figure-html/unnamed-chunk-32-1.png" alt="" width="672" />
...
## length [4] is not a sub-multiple or multiple of the number of rows [3]
```
...
## length [4] is not a sub-multiple or multiple of the number of columns [3]
```
...
```
## [1] "2^ 10 = 1024 is the first power of 2 above 1000"
```
...
<img src="bookdownproj_files/figure-html/ols-geometry-1.png" alt="OLS minimizes the sum of squared vertical distances (red segments). The slope and intercept are chosen so no other line achieves a smaller total." width="624" />
<p class="caption">(\#fig:ols-geometry)OLS minimizes the sum of squared vertical distances (red segments). The slope and intercept are chosen so no other line achieves a smaller total.</p>
</div>
...
<img src="bookdownproj_files/figure-html/unnamed-chunk-69-1.png" alt="" width="672" />
...
<div class="figure" style="text-align: center">
<img src="bookdownproj_files/figure-html/prf-diagram-1.png" alt="The Population Regression Function (blue line) connects the conditional means E[Y|X=x] at every value of x. The red curves show the conditional distribution of Y given X. OLS estimates this line from sample data." width="672" />
<p class="caption">(\#fig:prf-diagram)The Population Regression Function (blue line) connects the conditional means E[Y|X=x] at every value of x. The red curves show the conditional distribution of Y given X. OLS estimates this line from sample data.</p>
</div>
...
```
## Difference (due to noise):  -0.6521
```
...
```
## Test statistic:  Z = ( -0.652 - 0) / 2 = -0.326
```
...
```
## DECISION: Fail to reject H0  (|Z| = 0.326 <= z_crit = 1.96 )
```
...
```
## OUTCOME: Correct. We did not reject H0, and H0 is indeed TRUE.
```
...
```
## In every experiment, the true beta = 0 (H0 is always TRUE).
```
...
```
## First 10 simulated estimates of beta_hat:
```
...
```
##  [1]  1.105 -1.350  0.429  0.622  2.348  1.238 -0.225  1.834 -0.447  1.053
```
...
```
## SD of 10,000 estimates:   1.9866  (should be close to sigma_hat = 2 )
```
...
```
##  [1]  0.552 -0.675  0.214  0.311  1.174  0.619 -0.113  0.917 -0.223  0.526
```
...
```
## 
## Mean of Z statistics: 0.0052  (expected: 0)
```
...
```
## SD of Z statistics:   0.9933  (expected: 1)
```
...
```
## Empirical Type I error rate: 0.0477  -- target: alpha = 0.05
```
...
<img src="bookdownproj_files/figure-html/size-step5-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
```
## The distribution has shifted RIGHT by 3 units.
```
...
```
## Right tail contribution: P(Z > 1.96) = 0.8508
```
...
```
## Left  tail contribution: P(Z < -1.96) = 0
```
...
```
## Power at beta* = 6:       0.8508 -- i.e. 85.1 %
```
...
```
## Analytical power at beta* = 6 : 0.8508
```
...
```
## Simulated  power at beta* = 6 : 0.8445
```
...
```
## They agree: the formula is correct.
```
...
<img src="bookdownproj_files/figure-html/power-step4-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
<img src="bookdownproj_files/figure-html/power-step5-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
```
## OLS results from this one sample:
```
...
```
##   beta_hat_0 (intercept) = 1.017   [true value: 1 ]
```
...
```
##   beta_hat_1 (slope)     = 3.017   [true value: 3 ]
```
...
<img src="bookdownproj_files/figure-html/ols-step3b-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
```
##   Mean:    2.957  (should be close to true beta1 = 3 )
```
...
```
##   Range:   1.188  -- this is sampling variability
```
...
<img src="bookdownproj_files/figure-html/ols-step4-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
```
## Results from 2000 OLS estimates:
```
...
```
##   Theoretical SE:       0.253  (from Theorem 2.2: sigma/sqrt(E[SST_x]))
```
...
<img src="bookdownproj_files/figure-html/ols-step5b-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
```
## Manual construction of the 95% CI:
```
...
```
## They match -- confint() is doing exactly beta_hat +/- t * SE.
```
...
```
## -> YES. The interval contains the truth.
```
...
<img src="bookdownproj_files/figure-html/ci-step4-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
<img src="bookdownproj_files/figure-html/ci-step5-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
<img src="bookdownproj_files/figure-html/error-types-diagram-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
<img src="bookdownproj_files/figure-html/power-function-1.png" alt="" width="100%" style="display: block; margin: auto;" />
...
<img src="bookdownproj_files/figure-html/sim-plot-1.png" alt="" width="100%" style="display: block; margin: auto;" />
