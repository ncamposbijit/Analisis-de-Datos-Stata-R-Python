---
title: "Tutorial 6 — Variance of the OLS Estimator and Hypothesis Testing"
subtitle: "Introductory Econometrics — TA Session"
date: "Duration: 50 minutes | Based on Wooldridge, Theorem 2.2, Sections 2.5 and 4.1–4.2"
output:
  html_document:
    theme: flatly
    toc: true
...
.book-example {
  ...
  border-left: 4px solid rgba(0,70,130,0.5);
  border-radius: 4px;
  padding: 15px 18px;
  margin: 12px 0;
}
...
details.solution {
  background-color: rgba(0,100,60,0.05);
  border: 1px solid rgba(0,100,60,0.5);
  border-radius: 4px;
  padding: 12px 16px;
  margin: 10px 0;
}
